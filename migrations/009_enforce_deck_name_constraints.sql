  ...
  WITH invalid_deck_name AS (
    SELECT id
     ...
     WHERE name IS NULL
        ...
        OR name ~ U&'[\0001-\001F\007F-\009F\061C\200E\200F\2028\2029\202A-\202E\2066-\2069\FEFF]'
  ),
...
ALTER TABLE decks
  ...
  ADD CONSTRAINT decks_name_safe_characters_check CHECK (
    name !~ U&'[\0001-\001F\007F-\009F\061C\200E\200F\2028\2029\202A-\202E\2066-\2069\FEFF]'
  );
